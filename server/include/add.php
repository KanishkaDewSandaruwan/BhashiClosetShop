...
function addProduct($data, $img)
{
	...
	if ($count == 0) {
		...
		$sql = "INSERT INTO products(product_name, product_description, product_price, product_qty, product_active, date_updated, is_deleted, product_image, cat_id) VALUES('$product_name', '$product_description', '$product_price', '$product_qty', '$product_active', now(), 0 ,'$img', '$cat_id')";
		return mysqli_query($con, $sql);
